...
latex_documents = [
    ('index', 'delfi.tex', u'delfi Documentation',
     u'Mackelab', 'manual'),
]
...
man_pages = [
    ('index', 'delfi', u'delfi Documentation',
     [u'Mackelab'], 1)  # author field
]
...
texinfo_documents = [
    ('index', 'delfi', u'delfi Documentation',
     u'jm', 'delfi', 'One line description of project.',
     'Miscellaneous'),
]
